...
<body>
	...
	<br>
		...
		<form class="form-horizontal" action="${pageContext.request.contextPath}/LoginServlet?cmd=register"
		method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="gender"
						placeholder="Gender" name="gender" onclick="checkGender()">
				</div>
...
<script type="text/javascript">
	...
	function checkGender(){
		...
		gSpan.innerHTML="<font color='blue'>请输入性别:'f'或者'n'</font>";
	}
